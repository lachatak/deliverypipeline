...
staging_url = "deliverypipeline-staging.elasticbeanstalk.com"
...
target_environment_name = results['Environments'].select { |item| item['CNAME']==staging_url }.collect {|item| item['EnvironmentName'] }[0]
